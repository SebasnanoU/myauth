...
DATABASES = {
    'default': dj_database_url.config(default=os.environ.get('AA_DB_LINK'))
}
""" DATABASES["default"] = {
    ...
    #"MYSQL_ATTR_SSL_CA": 'os.environ.get("AA_DB_SSL_CA")',
    "OPTIONS": {
        #'sslmode': 'require',
        #'ssl': {'ca': os.environ.get("AA_DB_SSL_CA")},
...
BROKER_URL = f'{os.environ.get("AA_REDIS")}'
CACHES = {
    'default': {
        'BACKEND': 'django_redis.cache.RedisCache',
        'LOCATION': f'{os.environ.get("AA_REDIS")}',
    }
}
